  ...
  return (
    ...
    >
      <div className="rounded-xl bg-obsidian/80 backdrop-blur-sm border border-silver-mist/20 p-1.5 flex flex-col items-center gap-0.5">
        ...
        <button
          onClick={lookIso}
          className="w-full h-5 cursor-pointer rounded-sm text-[8px] font-semibold bg-amber-50 text-silver-mist/50 hover:bg-slate/40 hover:text-snow transition-all mt-0.5"
        >
          ISO
        </button>
      </div>
