# Delta Spec: cad-repair-loop

## MODIFIED: Tool result truncation on retry
...
## MODIFIED: Code re-hydration via session map
...
## ADDED: Snapshot mandate for COMPLEX tier
